...
$("#adddogform").submit(function(event){
    ...
    $.ajax({
       ...
       $(function(){  
           $("#confirmedmatches").fadeOut();
           $("#spinner").show();
          $.ajax({
        url: "confirmedmatchescode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
...
$(document).on("click", "#decline_request", function(event){
    ...
    else
   {
        ...
        success: function(data){
                    if(data == "reload")
                    {
                        alert("The action can't be done due to changes in the webpage. Please reload for fresh content")
                        location.reload(true);
                    }
...
$(document).on("click", "#cancelrequest", function(event){
    event.preventDefault();
    var confirmation = confirm("Are you sure you want to cancel request.Once Cancelled it cannot be undone?");
    var buttonname = $(this).attr('name'); 
    var id = extractid(buttonname);
    var datatopost = {'sentfrom' : id.sentfrom,
    'sentto' : id.sentto};
...
$(document).on("click", "#proceed", function(event){
    ...
    var datatopost = {'sentfrom' : id.sentfrom,
    'sentto' : id.sentto};
    var confirmation = confirm("Are you sure you want to proceed to book an appointment?");
    ...
    $.ajax({
        ...
        success: function(data){
                        ...
                        if(data == "repayment")
                        {
                            alert("It seems you have already paid for this match. If you pay again your money will be debited twice");
                            location.reload(true);
                        }
                        if(data == "success")
                        {
        ...
        error: function(){
            alert("Cannot proceed right now. Please try again later")
        }
    });
}
else
