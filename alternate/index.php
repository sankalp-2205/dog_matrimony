  ...
  function emptyalltext()
{
    ...
    $.ajax({
        url: "http://websh.offyoucode.co.uk/dog%20matrimony/signup.php",
        type: "POST",
        data: datatopost,
    ...
    $("select.state").change(function(){
      console.log("Selected State")
        ...
        if(selectedstate == "Bihar" || selectedstate == "Delhi" || selectedstate == "Uttar Pradesh" || selectedstate == "Haryana")
        {
          ...
          $.ajax({
            type: "POST",
            url: "http://websh.offyoucode.co.uk/dog%20matrimony/getcities.php",
...
$("#login").click(function(event){
    ...
    console.log(datatopost);
    $.ajax({
        url: "http://websh.offyoucode.co.uk/dog%20matrimony/login.php",
        type: "POST",
        data: datatopost,
        success: function(data){
                    ...
                    else if(data == "nologinpassword")
                    {
                      ...
                      $("#loginmessage").html("");
                        ...
                        {
                            window.location = "http://websh.offyoucode.co.uk/dog%20matrimony/loggedin.php";
                        }
                    else
                        {
...
$(document).on("click", "#affiliateloginsubmit", function(event){
    ...
    $.ajax({
        url: "http://websh.offyoucode.co.uk/dog%20matrimony/affiliatelogin.php",
        type: "POST",
        data: datatopost,
        success: function(data){
                    if(data == "success")
                        {
                            window.location = "http://websh.offyoucode.co.uk/dog%20matrimony/affiliateloggedin.php";
                        }
                    else
                        {
