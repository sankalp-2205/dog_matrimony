...
<head>
  ...
  <title>Viewed Unattended Matches</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id = "viewed_unattended_matches"></div>
...
$(function(){ 
        $("#spinner").show();
        $("#viewed_unattended_matches").fadeOut();
          $.ajax({
        url: "viewed_unattended_matchescode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#viewed_unattended_matches").html(data);
                             $("#viewed_unattended_matches").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#viewed_unattended_matches").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#viewed_unattended_matches").slideDown();
        }
    });
  });
