...
$(function(){ 
        $("#spinner").show();
        $("#appointmenthistory").fadeOut();
          $.ajax({
        url: "appointmenthistorycode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#appointmenthistory").html(data);
                             $("#appointmenthistory").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#appointmenthistory").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#appointmenthistory").slideDown();
        }
    });
  });
