...
if($result = $link ->query($sql))
{
    while($rows = $result->fetch_array(MYSQLI_ASSOC))
    {
        ...
        if($result2 = $link ->query($sql2))
        {
            ...
            {
                //definitely active
                $sql7 = "SELECT * FROM appointments WHERE sentfrom = '$sentfrom' AND sentto = '$sentto' AND report_generated = false";
...
if($active !== 0)
{
    ...
    <div class='row'>
            ...
            <ul class='list-unstyled'>
                ...
                <li><a href='' title=''>Booking Sender($senderdog):<span class='pull-right'>$appointment_sender</span></a></li>
                <li><a href='' title=''>Booking Receiver($recieverdog):<span class='pull-right'>$appointment_receiver</span></a></li>
