...
<head>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://websh.offyoucode.co.uk/dogmatrimonyadmin/affiliates.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id = "allactiveappointments"></div>
...
$(function(){ 
        $("#spinner").show();
        $("#allactiveappointments").fadeOut();
          $.ajax({
        url: "allactiveappointmentscode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#allactiveappointments").html(data);
                             $("#allactiveappointments").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#allactiveappointments").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#allactiveappointments").slideDown();
        }
    });
  });
