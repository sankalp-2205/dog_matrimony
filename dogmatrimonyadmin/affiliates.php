...
$(function(){ 
        $("#spinner").show();
        $("#allaffiliates").fadeOut();
          $.ajax({
        url: "affiliatescode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#allaffiliates").html(data);
                             $("#allaffiliates").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#allaffiliates").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#allaffiliates").slideDown();
        }
    });
  });
