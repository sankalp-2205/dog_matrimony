...
$unviewedcard = "";
$sql = "SELECT * FROM requests WHERE appointment_sender = 'booked' AND appointment_receiver = 'booked'";
if($result = $link ->query($sql))
{
    while($rows = $result->fetch_array(MYSQLI_ASSOC))
    {
        ...
        $timeofconfirmation = $rows['time'];
        $timestampofconfirmation = strtotime("$timeofconfirmation");
        $timestampofconfirmation = $timestampofconfirmation + 34200;
        $deadlinetimestamp = $timestampofconfirmation + 86400;
        $currenttimestamp = time();
        $timeofconfirmation = date('d-m-Y H:i:s', $timestampofconfirmation);
    ...
    <div class='row'>
            ...
            <ul class='list-unstyled'>
            <li><a href='' title=''>Confirmation Time: <span class='pull-right'>$timeofconfirmation</span></a></li>
