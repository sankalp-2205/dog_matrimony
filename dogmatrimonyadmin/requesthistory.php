...
$(function(){ 
        $("#spinner").show();
        $("#requesthistory").fadeOut();
          $.ajax({
        url: "requesthistorycode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#requesthistory").html(data);
                             $("#requesthistory").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#requesthistory").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#requesthistory").slideDown();
        }
    });
  });
