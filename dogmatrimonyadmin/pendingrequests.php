...
$(function(){ 
        $("#spinner").show();
        $("#pendingrequests").fadeOut();
          $.ajax({
        url: "pendingrequestscode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#pendingrequests").html(data);
                             $("#pendingrequests").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#pendingrequests").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#pendingrequests").slideDown();
        }
    });
  });
