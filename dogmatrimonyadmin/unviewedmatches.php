...
$(function(){ 
        $("#spinner").show();
        $("#unviewedmatches").fadeOut();
          $.ajax({
        url: "unviewedmatchescode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#unviewedmatches").html(data);
                             $("#unviewedmatches").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#unviewedmatches").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#unviewedmatches").slideDown();
        }
    });
  });
