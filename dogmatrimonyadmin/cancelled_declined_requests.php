...
<head>
  ...
  <title>Cancelled/Declined Requests</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id = "cancelled_declined_requests"></div>
...
$(function(){ 
        $("#spinner").show();
        $("#cancelled_declined_requests").fadeOut();
          $.ajax({
        url: "cancelled_declined_requestscode.php",
        type: "POST",
        success: function(data){
                    if(data)
                        {
                          $("#spinner").hide();
                             $("#cancelled_declined_requests").html(data);
                             $("#cancelled_declined_requests").slideDown();
                        }
        },
        error: function(){
          $("#spinner").hide();
            $("#cancelled_declined_requests").html("<div class = 'alert alert-danger'>Issue with ajax call.Plz try later </div>");
            $("#cancelled_declined_requests").slideDown();
        }
    });
  });
